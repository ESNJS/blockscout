defmodule Explorer.Chain.SmartContract do
  ...
  * `"nonpayable"` - function does not accept Callisto.
    **NOTE**: Sending non-zero Callisto to non-payable function will revert the transaction.
  * `"payable"` - function accepts Callisto.
  """
